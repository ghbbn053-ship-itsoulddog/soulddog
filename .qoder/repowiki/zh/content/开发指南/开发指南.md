...
## 更新摘要
**变更内容**
- 更新开发环境访问地址从 localhost:3000 更改为 localhost:5000
- 更新所有相关配置文件中的端口配置
- 修正CORS配置以匹配新的端口设置
- 更新开发指南中的端口相关信息
...
**更新** 新增专用开发Dockerfile、热重载配置、卷挂载优化等开发工作流改进，显著提升开发体验与容器化开发效率。开发环境访问地址已更新为 localhost:5000，解决端口绑定冲突问题。
...
**章节来源**
- [README-Windows.md:156-162](file://README-Windows.md#L156-L162)
